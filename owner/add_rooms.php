...
<body>
 ...
 <div class="form">
   ...
   <input type="text" id="type" name="type" placeholder="Room Type">
   
   <input type="text" id="catagory" name="catagory" placeholder="Room Catagory">

   <input type="text" id="description" name="description" placeholder="Room Description">

   <input type="text" id="price" name="price" placeholder="Room Price">
   <h6>Upload Image</h6>
