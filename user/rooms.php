...
<htmml>
  ...
  <body>
    <div class="block_1">
      <h1>
        <?php echo $type; ?> ROOMS from different hotel
      </h1>
    ...
    <?php while ($row1 = mysqli_fetch_array($result1)) : ; ?>
      ...
      <div>
        <main class="grid">
          <?php 
          $sql2 = "select * from room_data where hotel_name= '$row1[hotel_name]' and  room_type='$room_type'";
          ...
          while ($row2 = mysqli_fetch_array($result2)) : ; ?>
            <article>
              ...
              <div class="text">
                ...
                <div class="button">
              <a href="room_booking.php?id=<?php echo $row2['room_id']; ?> "> Book a Room</a>
             </div>
              </div>
            </article>
            <?php endwhile; ?>
